...
namespace Seller.Server.Data.Migrations
{
    ...
    [Migration("20200704081325_NameChanged_of_UserSeller_2")]
    partial class NameChanged_of_UserSeller_2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Seller.Server.Data.Models.UserSeller", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Seller.Server.Data.Models.Deal", b =>
                {
                    b.HasOne("Seller.Server.Data.Models.UserSeller", "Buyer")
                        .WithMany("BuyDeals")
                    ...
                    b.HasOne("Seller.Server.Data.Models.UserSeller", "Seller")
                        .WithMany("SaleDeals")
            ...
            modelBuilder.Entity("Seller.Server.Data.Models.Listing", b =>
                {
                    ...
                    b.HasOne("Seller.Server.Data.Models.UserSeller", null)
                        .WithMany("Listings")
            ...
            modelBuilder.Entity("Seller.Server.Data.Models.UserSeller", b =>
                {
                    b.HasOne("Seller.Server.Data.Models.User", "User")
                        .WithOne("UserSeller")
                        .HasForeignKey("Seller.Server.Data.Models.UserSeller", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
