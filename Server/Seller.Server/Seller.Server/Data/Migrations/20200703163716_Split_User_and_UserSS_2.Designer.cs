...
namespace Seller.Server.Data.Migrations
{
    ...
    [Migration("20200703163716_Split_User_and_UserSS_2")]
    partial class Split_User_and_UserSS_2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Seller.Server.Data.Models.Deal", b =>
                {
                    b.HasOne("Seller.Server.Data.Models.UserSS", "Buyer")
                        .WithMany("BuyDeals")
            ...
            modelBuilder.Entity("Seller.Server.Data.Models.UserSS", b =>
                {
                    b.HasOne("Seller.Server.Data.Models.User", "User")
                        .WithOne("UserSS")
                        .HasForeignKey("Seller.Server.Data.Models.UserSS", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
